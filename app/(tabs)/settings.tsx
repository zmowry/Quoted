...
function makeStyles(colors: Colors, scale: (n: number) => number) {
  return StyleSheet.create({
    ...
    card: { backgroundColor: colors.white, borderRadius: 14, borderWidth: 1, borderColor: colors.border, padding: 16, shadowColor: colors.chocolate, shadowOpacity: 0.07, shadowRadius: 6, elevation: 2 },
    cardTitle: { fontSize: scale(18), fontWeight: '800', color: colors.chocolate },
